...
refers to an
<<Detailed-Description_Definitions_Array-Definitions,array definition>> via the
...
<<Scoping-of-Names_Qualified-Identifiers,qualified identifier>> that 
refers to a
<<Detailed-Description_Definitions_Struct-Definitions,struct definition>> via the
<<Scoping-of-Names_Resolution-of-Qualified-Identifiers,rules for name 
scoping>>. For example:
...
a
<<Detailed-Description_Definitions_Abstract-Type-Definitions,abstract type 
definition>> via the
<<Scoping-of-Names_Resolution-of-Qualified-Identifiers,rules for name 
scoping>>. For example:
