...
"active" => (token Tokens.ACTIVE);
"array" => (token Tokens.ARRAY);
"assert" => (token Tokens.ASSERT);
"async" => (token Tokens.ASYNC);
"at" => (token Tokens.AT);
"block" => (token Tokens.BLOCK);
"bool" => (token Tokens.BOOL);
"command" => (token Tokens.COMMAND);
"component" => (token Tokens.COMPONENT);
"constant" => (token Tokens.CONSTANT);
"default" => (token Tokens.DEFAULT);
"drop" => (token Tokens.DROP);
"enum" => (token Tokens.ENUM);
"event" => (token Tokens.EVENT);
"false" => (token Tokens.FALSE);
"get" => (token Tokens.GET);
"guarded" => (token Tokens.GUARDED);
...
"resp" => (token Tokens.RESP);
"set" => (token Tokens.SET);
"size" => (token Tokens.SIZE);
"string" => (token Tokens.STRING);
"struct" => (token Tokens.STRUCT);
"sync" => (token Tokens.SYNC);
"telemetry" => (token Tokens.TELEMETRY);
"time" => (token Tokens.TIME);
