...
[source,bash]
----
% export FPP_JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-17-oracle-graalvm.jdk/Contents/Home
----
...
[source,bash]
----
% export FPP_GRAALVM_JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-17-oracle-graalvm.jdk/Contents/Home
----
