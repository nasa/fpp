...
[source,bash]
----
% export FPP_JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-25-graalvm-community.jdk/Contents/Home
----
...
[source,bash]
----
% export FPP_GRAALVM_JAVA_HOME=/Library/Java/JavaVirtualMachines/jdk-25-graalvm-community.jdk/Contents/Home
----
...
. Ensure that GraalVM is installed, as described above.

. Run `./install-trace` to install JVM versions of the FPP tools with
tracing enabled in the `bin` directory.

. Delete all files in the directory
`compiler/lib/src/main/resources/META-INF/native-image`.
This step will clear out any old trace information.
