...
As of v0.3.0, modeling and translation of constants, types, enums, ports,
and components is supported.
...
To run these tests, you will need a Scala
installation available on the command line.
