  ...
  public Fw::Serializable
{
  ...
  public:
    ...
    enum {
      ...
      ELEMENT_SERIALIZED_SIZE = sizeof(SM_X),
  ...
  public:
    ...
    //! Copy constructor
    SM_A(
        const SM_A& obj //!< The source object
    );
  ...
  public:
    ...
    //! Equality operator
    bool operator==(
        const SM_A& obj //!< The other object
    ) const;
