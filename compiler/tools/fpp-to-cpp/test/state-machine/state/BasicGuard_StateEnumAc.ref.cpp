// ======================================================================
// \title  BasicGuard_StateEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for BasicGuard_State enum
// ======================================================================
...
#include "state-machine/state/BasicGuard_StateEnumAc.hpp"
...
namespace FppTest {
  ...
  namespace SmState {
    ...
    BasicGuard_State& BasicGuard_State ::
      operator=(const BasicGuard_State& obj)
    {
      this->e = obj.e;
      return *this;
    }
    ...
    std::ostream& operator<<(std::ostream& os, const BasicGuard_State& obj) {
      Fw::String s;
      obj.toString(s);
      os << s;
      return os;
