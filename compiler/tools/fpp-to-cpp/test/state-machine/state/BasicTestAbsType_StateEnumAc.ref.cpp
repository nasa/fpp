// ======================================================================
// \title  BasicTestAbsType_StateEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for BasicTestAbsType_State enum
// ======================================================================

#include <cstring>
#include <limits>

#include "BasicTestAbsType_StateEnumAc.hpp"
...
namespace FppTest {
  ...
  namespace SmState {
    ...
    BasicTestAbsType_State& BasicTestAbsType_State ::
      operator=(const BasicTestAbsType_State& obj)
    {
      this->e = obj.e;
#ifdef BUILD_UT
    ...
    std::ostream& operator<<(std::ostream& os, const BasicTestAbsType_State& obj) {
      Fw::String s;
      obj.toString(s);
      os << s;
      return os;
    ...
    bool BasicTestAbsType_State ::
      isValid() const
    {
      return BasicTestAbsType_State::isValid(this->e);
    }

    Fw::SerializeStatus BasicTestAbsType_State ::
      serializeTo(
      ...
      )
    {
      ...
      if ((status == Fw::FW_SERIALIZE_OK) && !BasicTestAbsType_State::isValid(es)) {
