// ======================================================================
// \title  BasicGuardU32_StateEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for BasicGuardU32_State enum
// ======================================================================
...
namespace FppTest {
  ...
  namespace SmState {
    ...
    BasicGuardU32_State& BasicGuardU32_State ::
      operator=(const BasicGuardU32_State& obj)
    {
      this->e = obj.e;
#ifdef BUILD_UT
    ...
    std::ostream& operator<<(std::ostream& os, const BasicGuardU32_State& obj) {
      Fw::String s;
      obj.toString(s);
      os << s;
      return os;
    ...
    bool BasicGuardU32_State ::
      isValid() const
    {
      return BasicGuardU32_State::isValid(this->e);
    }
      ...
      )
    {
      ...
      if ((status == Fw::FW_SERIALIZE_OK) && !BasicGuardU32_State::isValid(es)) {
