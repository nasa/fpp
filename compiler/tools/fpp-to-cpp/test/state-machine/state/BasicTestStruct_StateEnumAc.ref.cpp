// ======================================================================
// \title  BasicTestStruct_StateEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for BasicTestStruct_State enum
// ======================================================================

#include <cstring>
#include <limits>

#include "BasicTestStruct_StateEnumAc.hpp"
...
namespace FppTest {
  ...
  namespace SmState {
    ...
    BasicTestStruct_State& BasicTestStruct_State ::
      operator=(const BasicTestStruct_State& obj)
    {
      this->e = obj.e;
#ifdef BUILD_UT
    ...
    std::ostream& operator<<(std::ostream& os, const BasicTestStruct_State& obj) {
      Fw::String s;
      obj.toString(s);
      os << s;
      return os;
    ...
    bool BasicTestStruct_State ::
      isValid() const
    {
      return BasicTestStruct_State::isValid(this->e);
    }

    Fw::SerializeStatus BasicTestStruct_State ::
      serializeTo(
      ...
      )
    {
      ...
      if ((status == Fw::FW_SERIALIZE_OK) && !BasicTestStruct_State::isValid(es)) {
