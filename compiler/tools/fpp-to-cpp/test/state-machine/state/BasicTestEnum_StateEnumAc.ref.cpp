// ======================================================================
// \title  BasicTestEnum_StateEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for BasicTestEnum_State enum
// ======================================================================
...
#include "BasicTestEnum_StateEnumAc.hpp"
...
namespace FppTest {
  ...
  namespace SmState {
    ...
    BasicTestEnum_State& BasicTestEnum_State ::
      operator=(const BasicTestEnum_State& obj)
    {
      this->e = obj.e;
      return *this;
    }
    ...
    std::ostream& operator<<(std::ostream& os, const BasicTestEnum_State& obj) {
      Fw::String s;
      obj.toString(s);
      os << s;
      return os;
    ...
    bool BasicTestEnum_State ::
      isValid() const
    {
      return BasicTestEnum_State::isValid(this->e);
    }
      ...
      )
    {
      ...
      if ((status == Fw::FW_SERIALIZE_OK) && !BasicTestEnum_State::isValid(es)) {
