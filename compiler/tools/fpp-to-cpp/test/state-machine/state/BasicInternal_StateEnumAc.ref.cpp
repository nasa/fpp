// ======================================================================
// \title  BasicInternal_StateEnumAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for BasicInternal_State enum
// ======================================================================

#include <cstring>
#include <limits>

#include "BasicInternal_StateEnumAc.hpp"
...
namespace FppTest {
  ...
  namespace SmState {
    ...
    BasicInternal_State& BasicInternal_State ::
      operator=(const BasicInternal_State& obj)
    {
      this->e = obj.e;
#ifdef BUILD_UT
    ...
    std::ostream& operator<<(std::ostream& os, const BasicInternal_State& obj) {
      Fw::String s;
      obj.toString(s);
      os << s;
      return os;
    ...
    bool BasicInternal_State ::
      isValid() const
    {
      return BasicInternal_State::isValid(this->e);
    }

    Fw::SerializeStatus BasicInternal_State ::
      serializeTo(
      ...
      )
    {
      ...
      if ((status == Fw::FW_SERIALIZE_OK) && !BasicInternal_State::isValid(es)) {
    ...
    {
      return ((serialTypeValue >= __FPRIME_UNINITIALIZED) && (serialTypeValue <= S));
    }
