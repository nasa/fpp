...
struct TestAbsType final : public Fw::Serializable {
    ...
    //! Serialize function
    //! \return Status
    Fw::SerializeStatus serializeTo(Fw::LinearBufferBase& sbb,  //!< The serialize buffer base
    ...
    //! Deserialize method
    //! \return status
    Fw::SerializeStatus deserializeFrom(Fw::LinearBufferBase& sbb,  //!< The serialize buffer base
