// ======================================================================
// \title  ActiveComponentAc.hpp
// \author Generated by fpp-to-cpp
// \brief  hpp file for Active component base class
// ======================================================================

#ifndef ActiveComponentAc_HPP
#define ActiveComponentAc_HPP
  ...
  public Fw::ActiveComponentBase
{
    ...
    friend class ActiveComponentBaseFriend;
  ...
  PROTECTED:
    ...
    enum {
      ...
      OPCODE_CMD_ASYNC = 0x1, //! An async command with no params
      ...
      OPCODE_PARAMU32_SET = 0x24, //! A parameter with U32 data
      OPCODE_PARAMU32_SAVE = 0x25, //! A parameter with U32 data
      OPCODE_PARAMF64_SET = 0x26, //! A parameter with F64 data
      OPCODE_PARAMF64_SAVE = 0x27, //! A parameter with F64 data
      OPCODE_PARAMSTRING_SET = 0x28, //! A parameter with string data and default value
      OPCODE_PARAMSTRING_SAVE = 0x29, //! A parameter with string data and default value
      OPCODE_PARAMENUM_SET = 0x2a, //! A parameter with enum data
      OPCODE_PARAMENUM_SAVE = 0x2b, //! A parameter with enum data
      OPCODE_PARAMARRAY_SET = 0x2c, //! A parameter with array data, default value, and save opcode
      OPCODE_PARAMARRAY_SAVE = 0x35, //! A parameter with array data, default value, and save opcode
      OPCODE_PARAMSTRUCT_SET = 0x40, //! A parameter with struct data and set/save opcodes
      OPCODE_PARAMSTRUCT_SAVE = 0x45, //! A parameter with struct data and set/save opcodes
    };

    //! Event IDs
    enum {
      EVENTID_EVENTACTIVITYHIGH = 0x0, //! An active component
      EVENTID_EVENTACTIVITYLOWTHROTTLED = 0x10, //! An active component
      EVENTID_EVENTCOMMAND = 0x11, //! An active component
      EVENTID_EVENTDIAGNOSTIC = 0x12, //! An active component
      EVENTID_EVENTFATALTHROTTLED = 0x13, //! An active component
      EVENTID_EVENTWARNINGHIGH = 0x20, //! An active component
      EVENTID_EVENTWARNINGLOWTHROTTLED = 0x21, //! An active component
    };
  ...
  PROTECTED:
    ...
    //! Construct ActiveComponentBase object
    ActiveComponentBase(
        const char* compName = "" //!< The component name
    );

    //! Initialize ActiveComponentBase object
    void init(
    ...
    //! Destroy ActiveComponentBase object
  ...
  PROTECTED:
    ...
    //! Handler for input port cmdIn
    virtual void cmdIn_handler(
        NATIVE_INT_TYPE portNum, //!< The port number
  ...
  PRIVATE:
    ...
    NATIVE_UINT_TYPE m_EventActivityLowThrottledThrottle; //! Throttle for EventActivityLowThrottled
    NATIVE_UINT_TYPE m_EventFatalThrottledThrottle; //! Throttle for EventFatalThrottled
    NATIVE_UINT_TYPE m_EventWarningLowThrottledThrottle; //! Throttle for EventWarningLowThrottled
