  ...
  )
{
  ...
  {
    // ParamI32
    case PassiveTestComponentBase::PARAMID_PARAMI32:
...
Ports::InputNoArgsPort* PassiveTestTesterBase ::
...
Ports::InputNoArgsReturnPort* PassiveTestTesterBase ::
...
Ports::InputNoArgsStringReturnPort* PassiveTestTesterBase ::
...
Ports::InputAliasTypedPort* PassiveTestTesterBase ::
...
Ports::InputAliasTypedReturnPort* PassiveTestTesterBase ::
...
Ports::InputAliasTypedReturnStringPort* PassiveTestTesterBase ::
...
AliasPrim2 PassiveTestTesterBase ::
  ...
  )
{
  ...
  switch (id - idBase) {
    ...
    case PassiveTestComponentBase::EVENTID_EVENTACTIVITYLOWTHROTTLED: {
    ...
    case PassiveTestComponentBase::EVENTID_EVENTCOMMAND: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case PassiveTestComponentBase::EVENTID_EVENTDIAGNOSTIC: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case PassiveTestComponentBase::EVENTID_EVENTFATALTHROTTLED: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case PassiveTestComponentBase::EVENTID_EVENTWARNINGHIGH: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case PassiveTestComponentBase::EVENTID_EVENTWARNINGLOWTHROTTLED: {
#if FW_AMPCS_COMPATIBLE
      // For AMPCS, decode zero arguments
      Fw::SerializeStatus _zero_status = Fw::FW_SERIALIZE_OK;
      U8 _noArgs;
  ...
  )
{
  ...
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode =  PassiveTestComponentBase::OPCODE_PARAMI32_SET + idBase;
  ...
  )
{
  Fw::CmdArgBuffer args;
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode = PassiveTestComponentBase::OPCODE_PARAMI32_SAVE + idBase;
