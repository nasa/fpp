...
#endif
#include "test-base/PassiveSyncProductsComponentAc.hpp"
  ...
  serializeRecord_DataRecord(const PassiveSyncProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += PassiveSyncProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
NATIVE_INT_TYPE PassiveSyncProductsComponentBase ::
