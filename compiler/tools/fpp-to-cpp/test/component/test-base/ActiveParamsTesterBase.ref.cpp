...
AliasString ActiveParamsTesterBase ::
...
// ----------------------------------------------------------------------
 ...
 Fw::SerializeStatus ActiveParamsTesterBase ::
  ActiveParamsComponentBase_serializeParam(
  ...
  )
{
 ...
 Fw::SerializeStatus ActiveParamsTesterBase ::
  ActiveParamsComponentBase_deserializeParam(
      const Fw::FwPrmIdType id,
      Fw::ParamBuffer& buff
  )
{
