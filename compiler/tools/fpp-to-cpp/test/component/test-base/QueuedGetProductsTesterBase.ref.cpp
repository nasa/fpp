...
FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_cmdIn() const
{
  return QueuedGetProductsComponentBase::NUM_CMDIN_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_aliasTypedAsync() const
{
  return QueuedGetProductsComponentBase::NUM_ALIASTYPEDASYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_noArgsAliasStringReturnSync() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSALIASSTRINGRETURNSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_noArgsAsync() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSASYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_noArgsGuarded() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSGUARDED_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_noArgsReturnGuarded() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSRETURNGUARDED_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_noArgsReturnSync() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSRETURNSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_noArgsStringReturnSync() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSSTRINGRETURNSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_noArgsSync() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedAliasGuarded() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDALIASGUARDED_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedAliasReturnSync() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDALIASRETURNSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedAliasStringReturnSync() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDALIASSTRINGRETURNSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedAsync() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDASYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedAsyncAssert() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDASYNCASSERT_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedAsyncBlockPriority() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDASYNCBLOCKPRIORITY_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedAsyncDropPriority() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDASYNCDROPPRIORITY_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedGuarded() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDGUARDED_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedReturnGuarded() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDRETURNGUARDED_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedReturnSync() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDRETURNSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_to_typedSync() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDSYNC_INPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_cmdRegOut() const
{
  return QueuedGetProductsComponentBase::NUM_CMDREGOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_cmdResponseOut() const
{
  return QueuedGetProductsComponentBase::NUM_CMDRESPONSEOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_eventOut() const
{
  return QueuedGetProductsComponentBase::NUM_EVENTOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_prmGetOut() const
{
  return QueuedGetProductsComponentBase::NUM_PRMGETOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_prmSetOut() const
{
  return QueuedGetProductsComponentBase::NUM_PRMSETOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_productGetOut() const
{
  return QueuedGetProductsComponentBase::NUM_PRODUCTGETOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_productSendOut() const
{
  return QueuedGetProductsComponentBase::NUM_PRODUCTSENDOUT_OUTPUT_PORTS;
}
...
{
  return QueuedGetProductsComponentBase::NUM_TEXTEVENTOUT_OUTPUT_PORTS;
}
...
{
  return QueuedGetProductsComponentBase::NUM_TIMEGETOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_tlmOut() const
{
  return QueuedGetProductsComponentBase::NUM_TLMOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_noArgsOut() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_noArgsReturnOut() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSRETURNOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_noArgsStringReturnOut() const
{
  return QueuedGetProductsComponentBase::NUM_NOARGSSTRINGRETURNOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_typedAliasOut() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDALIASOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_typedAliasReturnOut() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDALIASRETURNOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_typedAliasReturnStringOut() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDALIASRETURNSTRINGOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_typedOut() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDOUT_OUTPUT_PORTS;
}

FwIndexType QueuedGetProductsTesterBase ::
  getNum_from_typedReturnOut() const
{
  return QueuedGetProductsComponentBase::NUM_TYPEDRETURNOUT_OUTPUT_PORTS;
}
