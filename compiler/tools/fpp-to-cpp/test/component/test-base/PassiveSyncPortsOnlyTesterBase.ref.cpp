// ======================================================================
// \title  PassiveSyncPortsOnlyTesterBase.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for PassiveSyncPortsOnly component test harness base class
// ======================================================================
...
void PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputCmdRegPort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputCmdResponsePort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputLogPort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputPrmGetPort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputPrmSetPort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputDpRequestPort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputDpSendPort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputLogTextPort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputTimePort* PassiveSyncPortsOnlyTesterBase ::
...
Fw::InputTlmPort* PassiveSyncPortsOnlyTesterBase ::
...
Ports::InputNoArgsPort* PassiveSyncPortsOnlyTesterBase ::
...
Ports::InputNoArgsReturnPort* PassiveSyncPortsOnlyTesterBase ::
...
Ports::InputTypedPort* PassiveSyncPortsOnlyTesterBase ::
...
Ports::InputTypedReturnPort* PassiveSyncPortsOnlyTesterBase ::
...
PassiveSyncPortsOnlyTesterBase ::
  PassiveSyncPortsOnlyTesterBase(
...
U32 PassiveSyncPortsOnlyTesterBase ::
...
F32 PassiveSyncPortsOnlyTesterBase ::
...
NATIVE_INT_TYPE PassiveSyncPortsOnlyTesterBase ::
...
bool PassiveSyncPortsOnlyTesterBase ::
...
{
  PassiveSyncPortsOnlyTesterBase* _testerBase = static_cast<PassiveSyncPortsOnlyTesterBase*>(callComp);
