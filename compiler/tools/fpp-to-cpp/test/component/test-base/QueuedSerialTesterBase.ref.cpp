  ...
  init(NATIVE_INT_TYPE instance)
{
  ...
  for (
    ...
    (void) snprintf(
      portName,
      sizeof portName,
      "%s" "_from_serialOut[" "%" PRI_PlatformIntType "]",
      this->m_objName,
      port
    );
  ...
  for (
    ...
    (void) snprintf(
      portName,
      sizeof portName,
      "%s" "_to_serialAsync[" "%" PRI_PlatformIntType "]",
      this->m_objName,
      port
    );
  ...
  for (
    ...
    (void) snprintf(
      portName,
      sizeof portName,
      "%s" "_to_serialAsyncAssert[" "%" PRI_PlatformIntType "]",
      this->m_objName,
      port
    );
  ...
  for (
    ...
    constexpr FwSizeType PORT_NAME_MAX_SIZE =
      FW_OBJ_NAME_MAX_SIZE +
      // Size includes terminating '\0'
      (sizeof "_to_serialAsyncBlockPriority[") +
      MAX_NUM_IDX_DIGITS +
      // Size includes terminating '\0'
      (sizeof "]");
    char portName[PORT_NAME_MAX_SIZE];
    (void) snprintf(
      portName,
      sizeof portName,
      "%s" "_to_serialAsyncBlockPriority[" "%" PRI_PlatformIntType "]",
      this->m_objName,
      port
    );
  ...
  for (
    ...
    constexpr FwSizeType PORT_NAME_MAX_SIZE =
      FW_OBJ_NAME_MAX_SIZE +
      // Size includes terminating '\0'
      (sizeof "_to_serialAsyncDropPriority[") +
      MAX_NUM_IDX_DIGITS +
      // Size includes terminating '\0'
      (sizeof "]");
    char portName[PORT_NAME_MAX_SIZE];
    (void) snprintf(
      portName,
      sizeof portName,
      "%s" "_to_serialAsyncDropPriority[" "%" PRI_PlatformIntType "]",
      this->m_objName,
      port
    );
  ...
  for (
    ...
    (void) snprintf(
      portName,
      sizeof portName,
      "%s" "_to_serialGuarded[" "%" PRI_PlatformIntType "]",
      this->m_objName,
      port
    );
  ...
  for (
    ...
    (void) snprintf(
      portName,
      sizeof portName,
      "%s" "_to_serialSync[" "%" PRI_PlatformIntType "]",
      this->m_objName,
      port
    );
