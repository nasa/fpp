...
// ----------------------------------------------------------------------
 ...
 Fw::SerializeStatus QueuedSerialTesterBase ::
  QueuedSerialComponentBase_serializeParam(
  ...
  )
{
 ...
 Fw::SerializeStatus QueuedSerialTesterBase ::
  QueuedSerialComponentBase_deserializeParam(
      const Fw::FwPrmIdType id,
      Fw::ParamBuffer& buff
  )
{
  ...
  )
{
  ...
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode =  QueuedSerialComponentBase::OPCODE_PARAMI32_SET + idBase;
  ...
  )
{
  Fw::CmdArgBuffer args;
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode = QueuedSerialComponentBase::OPCODE_PARAMI32_SAVE + idBase;
