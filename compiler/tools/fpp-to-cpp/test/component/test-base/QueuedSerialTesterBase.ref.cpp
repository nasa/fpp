// ======================================================================
// \title  QueuedSerialTesterBase.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for QueuedSerial component test harness base class
// ======================================================================
  ...
  )
{
  ...
  {
    // ParamI32Ext
    case QueuedSerialComponentBase::PARAMID_PARAMI32EXT:
      stat = buff.deserializeTo(this->m_param_ParamI32Ext);
      break;
    // ParamF64Ext
    case QueuedSerialComponentBase::PARAMID_PARAMF64EXT:
      stat = buff.deserializeTo(this->m_param_ParamF64Ext);
      break;
    // ParamStringExt
    case QueuedSerialComponentBase::PARAMID_PARAMSTRINGEXT:
      stat = buff.deserializeTo(this->m_param_ParamStringExt);
      break;
    // ParamEnumExt
    case QueuedSerialComponentBase::PARAMID_PARAMENUMEXT:
      stat = buff.deserializeTo(this->m_param_ParamEnumExt);
      break;
    // ParamArrayExt
    case QueuedSerialComponentBase::PARAMID_PARAMARRAYEXT:
      stat = buff.deserializeTo(this->m_param_ParamArrayExt);
      break;
    // ParamStructExt
    case QueuedSerialComponentBase::PARAMID_PARAMSTRUCTEXT:
  ...
  init(FwEnumStoreType instance)
{
  ...
  for (
    ...
    Fw::ObjectName portName;
    portName.format(
      "%s_to_serialAsync[%" PRI_FwIndexType "]",
      this->m_objName.toChar(),
      port
    );
  ...
  for (
    ...
    Fw::ObjectName portName;
    portName.format(
      "%s_to_serialAsyncAssert[%" PRI_FwIndexType "]",
      this->m_objName.toChar(),
      port
    );
  ...
  for (
    ...
    Fw::ObjectName portName;
    portName.format(
      "%s_to_serialAsyncBlockPriority[%" PRI_FwIndexType "]",
      this->m_objName.toChar(),
      port
    );
  ...
  for (
    ...
    Fw::ObjectName portName;
    portName.format(
      "%s_to_serialAsyncDropPriority[%" PRI_FwIndexType "]",
      this->m_objName.toChar(),
      port
    );
...
Fw::InputCmdRegPort* QueuedSerialTesterBase ::
...
Fw::InputCmdResponsePort* QueuedSerialTesterBase ::
...
Fw::InputLogPort* QueuedSerialTesterBase ::
...
Fw::InputPrmGetPort* QueuedSerialTesterBase ::
...
Fw::InputPrmSetPort* QueuedSerialTesterBase ::
...
Fw::InputLogTextPort* QueuedSerialTesterBase ::
...
Fw::InputTimePort* QueuedSerialTesterBase ::
...
Fw::InputTlmPort* QueuedSerialTesterBase ::
...
Ports::InputNoArgsPort* QueuedSerialTesterBase ::
...
Ports::InputNoArgsReturnPort* QueuedSerialTesterBase ::
...
Ports::InputNoArgsStringReturnPort* QueuedSerialTesterBase ::
...
Ports::InputTypedReturnPort* QueuedSerialTesterBase ::
...
Fw::InputSerializePort* QueuedSerialTesterBase ::
...
Fw::String QueuedSerialTesterBase ::
  ...
  )
{
  ...
  switch (id - idBase) {
    ...
    case QueuedSerialComponentBase::EVENTID_EVENTACTIVITYLOWTHROTTLED: {
    ...
    case QueuedSerialComponentBase::EVENTID_EVENTCOMMAND: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case QueuedSerialComponentBase::EVENTID_EVENTDIAGNOSTIC: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case QueuedSerialComponentBase::EVENTID_EVENTFATALTHROTTLED: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case QueuedSerialComponentBase::EVENTID_EVENTWARNINGHIGH: {
      Fw::SerializeStatus _status = Fw::FW_SERIALIZE_OK;
    ...
    case QueuedSerialComponentBase::EVENTID_EVENTWARNINGLOWTHROTTLED: {
#if FW_AMPCS_COMPATIBLE
      // For AMPCS, decode zero arguments
      Fw::SerializeStatus _zero_status = Fw::FW_SERIALIZE_OK;
      U8 _noArgs;
    ...
    case QueuedSerialComponentBase::EVENTID_EVENTWARNINGLOWTHROTTLEDINTERVAL: {
#if FW_AMPCS_COMPATIBLE
      // For AMPCS, decode zero arguments
      Fw::SerializeStatus _zero_status = Fw::FW_SERIALIZE_OK;
      U8 _noArgs;
  ...
  )
{
  ...
  switch (id - idBase) {
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELF32FORMAT: {
      F32 arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELSTRINGFORMAT: {
      Fw::TlmString arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELENUM: {
      E arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELARRAYFREQ: {
      A arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELSTRUCTFREQ: {
      S arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELU32LIMITS: {
      U32 arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELF32LIMITS: {
      F32 arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELF64: {
      F64 arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELU32ONCHANGE: {
      U32 arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELENUMONCHANGE: {
      E arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
    ...
    case QueuedSerialComponentBase::CHANNELID_CHANNELBOOLONCHANGE: {
      bool arg;
      const Fw::SerializeStatus _status = val.deserializeTo(arg);
...
Fw::ParamValid QueuedSerialTesterBase ::
  from_prmGetOut_static(
      Fw::PassiveComponentBase* const callComp,
      FwIndexType portNum,
      FwPrmIdType id,
  ...
  )
{
  ...
  switch (id - idBase) {
    ...
    case QueuedSerialComponentBase::PARAMID_PARAMF64: {
    ...
    case QueuedSerialComponentBase::PARAMID_PARAMSTRING: {
    ...
    case QueuedSerialComponentBase::PARAMID_PARAMENUM: {
    ...
    case QueuedSerialComponentBase::PARAMID_PARAMARRAY: {
    ...
    case QueuedSerialComponentBase::PARAMID_PARAMSTRUCT: {
