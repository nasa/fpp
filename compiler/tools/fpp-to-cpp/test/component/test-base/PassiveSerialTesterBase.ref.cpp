...
AliasString PassiveSerialTesterBase ::
...
// ----------------------------------------------------------------------
 ...
 Fw::SerializeStatus PassiveSerialTesterBase ::
  PassiveSerialComponentBase_serializeParam(
  ...
  )
{
 ...
 Fw::SerializeStatus PassiveSerialTesterBase ::
  PassiveSerialComponentBase_deserializeParam(
      const Fw::FwPrmIdType id,
      Fw::ParamBuffer& buff
  )
{
  ...
  )
{
  ...
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode =  PassiveSerialComponentBase::OPCODE_PARAMI32_SET + idBase;
  ...
  )
{
  Fw::CmdArgBuffer args;
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode = PassiveSerialComponentBase::OPCODE_PARAMI32_SAVE + idBase;
  ...
  )
{
  ...
  switch (id - idBase) {
    ...
    case PassiveSerialComponentBase::PARAMID_PARAMI32: {
