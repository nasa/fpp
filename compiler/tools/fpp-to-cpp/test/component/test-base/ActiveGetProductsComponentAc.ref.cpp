  ...
  serializeRecord_DataRecord(const ActiveGetProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += ActiveGetProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
Fw::InputDpResponsePort* ActiveGetProductsComponentBase ::
...
NATIVE_INT_TYPE ActiveGetProductsComponentBase ::
