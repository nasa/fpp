...
Fw::InputCmdRegPort* PassiveGetPortsOnlyTesterBase ::
...
Fw::InputCmdResponsePort* PassiveGetPortsOnlyTesterBase ::
...
Fw::InputLogPort* PassiveGetPortsOnlyTesterBase ::
...
Fw::InputPrmGetPort* PassiveGetPortsOnlyTesterBase ::
...
Fw::InputPrmSetPort* PassiveGetPortsOnlyTesterBase ::
...
Fw::InputLogTextPort* PassiveGetPortsOnlyTesterBase ::
...
Fw::InputTimePort* PassiveGetPortsOnlyTesterBase ::
...
Fw::InputTlmPort* PassiveGetPortsOnlyTesterBase ::
...
Ports::InputNoArgsPort* PassiveGetPortsOnlyTesterBase ::
...
Ports::InputNoArgsReturnPort* PassiveGetPortsOnlyTesterBase ::
...
Ports::InputTypedPort* PassiveGetPortsOnlyTesterBase ::
...
Ports::InputTypedReturnPort* PassiveGetPortsOnlyTesterBase ::
...
U32 PassiveGetPortsOnlyTesterBase ::
...
F32 PassiveGetPortsOnlyTesterBase ::
...
{
  PassiveGetPortsOnlyTesterBase* _testerBase = static_cast<PassiveGetPortsOnlyTesterBase*>(callComp);
