// ======================================================================
// \title  QueuedAsyncProductsTesterBase.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for QueuedAsyncProducts component test harness base class
// ======================================================================

#include <cstdlib>
#include <cstring>

#include "test-base/QueuedAsyncProductsTesterBase.hpp"

// ----------------------------------------------------------------------
// Component initialization
// ----------------------------------------------------------------------

void QueuedAsyncProductsTesterBase ::
...
Fw::InputCmdRegPort* QueuedAsyncProductsTesterBase ::
...
Fw::InputCmdResponsePort* QueuedAsyncProductsTesterBase ::
...
Fw::InputLogPort* QueuedAsyncProductsTesterBase ::
...
Fw::InputPrmGetPort* QueuedAsyncProductsTesterBase ::
...
Fw::InputPrmSetPort* QueuedAsyncProductsTesterBase ::
...
Fw::InputDpRequestPort* QueuedAsyncProductsTesterBase ::
...
Fw::InputDpSendPort* QueuedAsyncProductsTesterBase ::
...
Fw::InputLogTextPort* QueuedAsyncProductsTesterBase ::
...
Fw::InputTimePort* QueuedAsyncProductsTesterBase ::
...
Fw::InputTlmPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputNoArgsPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputNoArgsReturnPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputNoArgsStringReturnPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputAliasTypedPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputAliasTypedReturnPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputAliasTypedReturnStringPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputTypedPort* QueuedAsyncProductsTesterBase ::
...
Ports::InputTypedReturnPort* QueuedAsyncProductsTesterBase ::
...
U32 QueuedAsyncProductsTesterBase ::
...
Fw::String QueuedAsyncProductsTesterBase ::
...
AliasPrim2 QueuedAsyncProductsTesterBase ::
...
AliasString QueuedAsyncProductsTesterBase ::
...
F32 QueuedAsyncProductsTesterBase ::
...
QueuedAsyncProductsComponentBase::MsgDispatchStatus QueuedAsyncProductsTesterBase ::
  dispatchOne(QueuedAsyncProductsComponentBase& component)
{
...
QueuedAsyncProductsComponentBase::MsgDispatchStatus QueuedAsyncProductsTesterBase ::
  dispatchCurrentMessages(QueuedAsyncProductsComponentBase& component)
{
      ...
      QueuedAsyncProductsComponentBase::MsgDispatchStatus messageStatus = QueuedAsyncProductsComponentBase::MsgDispatchStatus::MSG_DISPATCH_EMPTY;
      for (FwSizeType i = 0; i < currentMessageCount; i++) {
          messageStatus = component.doDispatch();
          if (messageStatus != QueuedAsyncProductsComponentBase::MSG_DISPATCH_OK) {
              break;
          }
      }
...
{
  QueuedAsyncProductsTesterBase* _testerBase = static_cast<QueuedAsyncProductsTesterBase*>(callComp);
