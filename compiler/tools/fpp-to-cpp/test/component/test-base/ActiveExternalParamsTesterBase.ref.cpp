  ...
  )
{
  ...
  {
    // ParamI32
    case ActiveExternalParamsComponentBase::PARAMID_PARAMI32:
  ...
  )
{
  ...
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode =  ActiveExternalParamsComponentBase::OPCODE_PARAMI32_SET + idBase;
  ...
  )
{
  Fw::CmdArgBuffer args;
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode = ActiveExternalParamsComponentBase::OPCODE_PARAMI32_SAVE + idBase;
