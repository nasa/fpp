...
Ports::InputNoArgsStringReturnPort* ActiveSerialTesterBase ::
...
Ports::InputAliasTypedPort* ActiveSerialTesterBase ::
...
Ports::InputAliasTypedReturnPort* ActiveSerialTesterBase ::
...
Ports::InputAliasTypedReturnStringPort* ActiveSerialTesterBase ::
...
Fw::String ActiveSerialTesterBase ::
...
AliasPrim2 ActiveSerialTesterBase ::
...
AliasString ActiveSerialTesterBase ::
...
// ----------------------------------------------------------------------
 ...
 Fw::SerializeStatus ActiveSerialTesterBase ::
  ActiveSerialComponentBase_serializeParam(
  ...
  )
{
 ...
 Fw::SerializeStatus ActiveSerialTesterBase ::
  ActiveSerialComponentBase_deserializeParam(
      const Fw::FwPrmIdType id,
      Fw::ParamBuffer& buff
  )
{
  ...
  )
{
  ...
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode =  ActiveSerialComponentBase::OPCODE_PARAMI32_SET + idBase;
  ...
  )
{
  Fw::CmdArgBuffer args;
  const U32 idBase = this->getIdBase();
  FwOpcodeType _prmOpcode = ActiveSerialComponentBase::OPCODE_PARAMI32_SAVE + idBase;
  ...
  )
{
  ...
  switch (id - idBase) {
    ...
    case ActiveSerialComponentBase::PARAMID_PARAMI32: {
