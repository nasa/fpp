// ======================================================================
// \title  ActiveProductsComponentAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for ActiveProducts component base class
// ======================================================================

#include <cstdio>

#include "ActiveProductsComponentAc.hpp"
...
namespace {
  enum MsgTypeEnum {
    ACTIVEPRODUCTS_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
...
ActiveProductsComponentBase::DpContainer ::
  DpContainer(
      FwDpIdType id,
...
Fw::SerializeStatus ActiveProductsComponentBase::DpContainer ::
  serializeRecord_DataRecord(const ActiveProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += ActiveProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
void ActiveProductsComponentBase ::
  init(
...
Fw::InputCmdPort* ActiveProductsComponentBase ::
...
Fw::InputDpResponsePort* ActiveProductsComponentBase ::
...
InputNoArgsPort* ActiveProductsComponentBase ::
...
InputNoArgsReturnPort* ActiveProductsComponentBase ::
...
InputTypedPort* ActiveProductsComponentBase ::
...
InputTypedReturnPort* ActiveProductsComponentBase ::
...
ActiveProductsComponentBase ::
  ActiveProductsComponentBase(const char* compName) :
...
NATIVE_INT_TYPE ActiveProductsComponentBase ::
...
bool ActiveProductsComponentBase ::
...
U32 ActiveProductsComponentBase ::
...
F32 ActiveProductsComponentBase ::
...
Fw::Time ActiveProductsComponentBase ::
  getTime()
{
...
Fw::QueuedComponentBase::MsgDispatchStatus ActiveProductsComponentBase ::
  doDispatch()
{
  ComponentIpcSerializableBuffer msg;
  ...
  if (msgType == ACTIVEPRODUCTS_COMPONENT_EXIT) {
...
{
  FW_ASSERT(callComp);
  ActiveProductsComponentBase* compPtr = static_cast<ActiveProductsComponentBase*>(callComp);
