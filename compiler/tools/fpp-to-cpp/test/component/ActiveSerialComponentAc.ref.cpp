...
InputNoArgsPort* ActiveSerialComponentBase ::
...
InputNoArgsReturnPort* ActiveSerialComponentBase ::
...
InputTypedPort* ActiveSerialComponentBase ::
...
InputTypedReturnPort* ActiveSerialComponentBase ::
  ...
  )
{
  ...
  // Connect input port ActiveSerial
  for (
  ...
  // Connect output port ActiveSerial
  for (
    PlatformIntType port = 0;
