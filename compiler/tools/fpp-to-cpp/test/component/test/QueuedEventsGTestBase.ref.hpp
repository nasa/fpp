// ======================================================================
// \title  QueuedEventsGTestBase.hpp
// \author Generated by fpp-to-cpp
// \brief  hpp file for QueuedEvents component Google Test harness base class
// ======================================================================

#ifndef QueuedEventsGTestBase_HPP
#define QueuedEventsGTestBase_HPP
...
#define ASSERT_EVENTS_EventActivityHigh(size) \
  this->assertEvents_EventActivityHigh(__FILE__, __LINE__, size)
...
#define ASSERT_EVENTS_EventWarningLowThrottled(size) \
  this->assertEvents_EventWarningLowThrottled(__FILE__, __LINE__, size)
...
//! \class QueuedEventsGTestBase
//! \brief Auto-generated base for QueuedEvents component Google Test harness
class QueuedEventsGTestBase :
  public QueuedEventsTesterBase
{
  ...
  protected:
    ...
    //! Construct object QueuedEventsGTestBase
    QueuedEventsGTestBase(
        const char* const compName, //!< The component name
        const U32 maxHistorySize //!< The maximum size of each history
    );

    //! Destroy object QueuedEventsGTestBase
    ~QueuedEventsGTestBase();
  ...
  protected:
    ...
    void assertEvents_EventActivityHigh(
        const char* const __callSiteFileName, //!< The name of the file containing the call site
        const U32 __callSiteLineNumber, //!< The line number of the call site
    ...
    void assertEvents_EventWarningLowThrottled(
        const char* const __callSiteFileName, //!< The name of the file containing the call site
        const U32 __callSiteLineNumber, //!< The line number of the call site
        const U32 __index //!< The index
    ) const;
