  ...
  serializeRecord_DataRecord(const QueuedTest_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += QueuedTest_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
InputTypedPort* QueuedTestComponentBase ::
...
InputTypedReturnPort* QueuedTestComponentBase ::
  ...
  doDispatch()
{
  ...
  if (msgType == QUEUEDTEST_COMPONENT_EXIT) {
