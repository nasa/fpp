// ======================================================================
// \title  ActiveDpComponentAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for ActiveDp component base class
// ======================================================================

#include <cstdio>

#include "ActiveDpComponentAc.hpp"
...
namespace {
  enum MsgTypeEnum {
    ACTIVEDP_COMPONENT_EXIT = Fw::ActiveComponentBase::ACTIVE_COMPONENT_EXIT,
...
ActiveDpComponentBase::DpContainer ::
  DpContainer(
      FwDpIdType id,
...
Fw::SerializeStatus ActiveDpComponentBase::DpContainer ::
  serializeRecord_DataRecord(const ActiveDp_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += ActiveDp_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
Fw::InputCmdPort* ActiveDpComponentBase ::
...
Fw::InputDpResponsePort* ActiveDpComponentBase ::
...
InputNoArgsPort* ActiveDpComponentBase ::
...
InputNoArgsReturnPort* ActiveDpComponentBase ::
...
InputTypedPort* ActiveDpComponentBase ::
...
InputTypedReturnPort* ActiveDpComponentBase ::
...
ActiveDpComponentBase ::
  ActiveDpComponentBase(const char* compName) :
...
NATIVE_INT_TYPE ActiveDpComponentBase ::
...
Fw::QueuedComponentBase::MsgDispatchStatus ActiveDpComponentBase ::
  doDispatch()
{
  ComponentIpcSerializableBuffer msg;
  ...
  if (msgType == ACTIVEDP_COMPONENT_EXIT) {
...
{
  FW_ASSERT(callComp);
  ActiveDpComponentBase* compPtr = static_cast<ActiveDpComponentBase*>(callComp);
