// ======================================================================
// \title  QueuedExternalParams.hpp
// \author [user name]
// \brief  hpp file for QueuedExternalParams component implementation class
// ======================================================================

#ifndef QueuedExternalParams_HPP
#define QueuedExternalParams_HPP

#include "QueuedExternalParamsComponentAc.hpp"

class QueuedExternalParams final :
  public QueuedExternalParamsComponentBase
{
  ...
  public:
    ...
    //! Destroy QueuedExternalParams object
    ~QueuedExternalParams();
