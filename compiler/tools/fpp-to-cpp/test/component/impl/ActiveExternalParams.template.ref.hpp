// ======================================================================
// \title  ActiveExternalParams.hpp
// \author [user name]
// \brief  hpp file for ActiveExternalParams component implementation class
// ======================================================================

#ifndef ActiveExternalParams_HPP
#define ActiveExternalParams_HPP

#include "ActiveExternalParamsComponentAc.hpp"

class ActiveExternalParams final :
  public ActiveExternalParamsComponentBase
{
  ...
  public:
    ...
    //! Construct ActiveExternalParams object
