// ======================================================================
// \title  SmStateQueued.cpp
// \author [user name]
// \brief  cpp file for SmStateQueued component implementation class
// ======================================================================

#include "SmStateQueued.hpp"
...
namespace FppTest {
  ...
  SmStateQueued ::
    SmStateQueued(const char* const compName) :
      SmStateQueuedComponentBase(compName)
  {
