  ...
  serializeRecord_DataRecord(const QueuedSyncProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += QueuedSyncProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
InputNoArgsPort* QueuedSyncProductsComponentBase ::
...
InputNoArgsReturnPort* QueuedSyncProductsComponentBase ::
...
InputTypedPort* QueuedSyncProductsComponentBase ::
...
InputTypedReturnPort* QueuedSyncProductsComponentBase ::
