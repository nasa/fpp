// ======================================================================
// \title  PassiveSyncProductsComponentAc.cpp
// \author Generated by fpp-to-cpp
// \brief  cpp file for PassiveSyncProducts component base class
// ======================================================================
...
#endif
#include "base/PassiveSyncProductsComponentAc.hpp"
...
Fw::InputCmdPort* PassiveSyncProductsComponentBase ::
...
Fw::InputDpResponsePort* PassiveSyncProductsComponentBase ::
...
Ports::InputNoArgsAliasStringReturnPort* PassiveSyncProductsComponentBase ::
...
Ports::InputNoArgsPort* PassiveSyncProductsComponentBase ::
...
Ports::InputNoArgsReturnPort* PassiveSyncProductsComponentBase ::
...
Ports::InputNoArgsStringReturnPort* PassiveSyncProductsComponentBase ::
...
Ports::InputAliasTypedPort* PassiveSyncProductsComponentBase ::
...
Ports::InputAliasTypedReturnPort* PassiveSyncProductsComponentBase ::
...
Ports::InputAliasTypedReturnStringPort* PassiveSyncProductsComponentBase ::
...
Ports::InputTypedPort* PassiveSyncProductsComponentBase ::
...
Ports::InputTypedReturnPort* PassiveSyncProductsComponentBase ::
...
PassiveSyncProductsComponentBase ::
  PassiveSyncProductsComponentBase(const char* compName) :
...
FwIndexType PassiveSyncProductsComponentBase ::
...
AliasString PassiveSyncProductsComponentBase ::
...
AliasPrim2 PassiveSyncProductsComponentBase ::
...
F32 PassiveSyncProductsComponentBase ::
