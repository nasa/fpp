...
#endif
#include "base/QueuedAsyncProductsComponentAc.hpp"
  ...
  serializeRecord_DataRecord(const QueuedAsyncProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += QueuedAsyncProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
InputNoArgsReturnPort* QueuedAsyncProductsComponentBase ::
...
InputTypedPort* QueuedAsyncProductsComponentBase ::
...
InputTypedReturnPort* QueuedAsyncProductsComponentBase ::
...
NATIVE_INT_TYPE QueuedAsyncProductsComponentBase ::
  ...
  doDispatch()
{
  ...
  if (msgType == QUEUEDASYNCPRODUCTS_COMPONENT_EXIT) {
