...
#endif
#include "base/ActiveGuardedProductsComponentAc.hpp"
  ...
  serializeRecord_DataRecord(const ActiveGuardedProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += ActiveGuardedProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
InputNoArgsPort* ActiveGuardedProductsComponentBase ::
...
InputNoArgsReturnPort* ActiveGuardedProductsComponentBase ::
...
InputTypedPort* ActiveGuardedProductsComponentBase ::
...
InputTypedReturnPort* ActiveGuardedProductsComponentBase ::
  ...
  doDispatch()
{
  ...
  if (msgType == ACTIVEGUARDEDPRODUCTS_COMPONENT_EXIT) {
