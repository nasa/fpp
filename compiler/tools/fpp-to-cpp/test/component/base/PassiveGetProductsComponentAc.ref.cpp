  ...
  serializeRecord_DataRecord(const PassiveGetProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += PassiveGetProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
Fw::InputDpResponsePort* PassiveGetProductsComponentBase ::
...
NATIVE_INT_TYPE PassiveGetProductsComponentBase ::
