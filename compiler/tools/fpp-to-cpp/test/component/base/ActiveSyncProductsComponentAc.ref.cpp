  ...
  serializeRecord_DataRecord(const ActiveSyncProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += ActiveSyncProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
InputNoArgsPort* ActiveSyncProductsComponentBase ::
...
InputNoArgsReturnPort* ActiveSyncProductsComponentBase ::
...
InputTypedPort* ActiveSyncProductsComponentBase ::
...
InputTypedReturnPort* ActiveSyncProductsComponentBase ::
  ...
  doDispatch()
{
  ...
  if (msgType == ACTIVESYNCPRODUCTS_COMPONENT_EXIT) {
