...
namespace FppTest {
  ...
  Svc::InputSchedPort* SmJunctionQueuedComponentBase ::
  ...
  FwIndexType SmJunctionQueuedComponentBase ::
  ...
  {
    FW_ASSERT(callComp);
    SmJunctionQueuedComponentBase* compPtr = static_cast<SmJunctionQueuedComponentBase*>(callComp);
