  ...
  serializeRecord_DataRecord(const PassiveGuardedProducts_Data& elt)
{
  ...
  if (status == Fw::FW_SERIALIZE_OK) {
    ...
    this->dataSize += PassiveGuardedProducts_Data::SERIALIZED_SIZE;
  }
  return status;
}
...
InputNoArgsPort* PassiveGuardedProductsComponentBase ::
...
InputNoArgsReturnPort* PassiveGuardedProductsComponentBase ::
...
InputTypedPort* PassiveGuardedProductsComponentBase ::
...
InputTypedReturnPort* PassiveGuardedProductsComponentBase ::
