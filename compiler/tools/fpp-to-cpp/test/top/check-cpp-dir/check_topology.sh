check_topology()
{
  ...
  then
    variable_flag_array='
    -DFW_DIRECT_PORT_CALLS=0:-DFW_ENABLE_TEXT_LOGGING=0:-DFW_STRICT_ASSERTIONS=0
    -DFW_DIRECT_PORT_CALLS=0:-DFW_ENABLE_TEXT_LOGGING=0:-DFW_STRICT_ASSERTIONS=1
    -DFW_DIRECT_PORT_CALLS=0:-DFW_ENABLE_TEXT_LOGGING=1:-DFW_STRICT_ASSERTIONS=0
    -DFW_DIRECT_PORT_CALLS=0:-DFW_ENABLE_TEXT_LOGGING=1:-DFW_STRICT_ASSERTIONS=1
    -DFW_DIRECT_PORT_CALLS=1:-DFW_ENABLE_TEXT_LOGGING=0:-DFW_STRICT_ASSERTIONS=0
    -DFW_DIRECT_PORT_CALLS=1:-DFW_ENABLE_TEXT_LOGGING=0:-DFW_STRICT_ASSERTIONS=1
    -DFW_DIRECT_PORT_CALLS=1:-DFW_ENABLE_TEXT_LOGGING=1:-DFW_STRICT_ASSERTIONS=0
    -DFW_DIRECT_PORT_CALLS=1:-DFW_ENABLE_TEXT_LOGGING=1:-DFW_STRICT_ASSERTIONS=1
    '
  fi
