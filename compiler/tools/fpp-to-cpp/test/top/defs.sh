...
export FPRIME_DEPS="$FPRIME_DIR/config/FpConfig.fpp,$FPRIME_DIR/Platform/PlatformTypes.fpp,$FPRIME_DIR/Fw/Types/Types.fpp,$FPRIME_DIR/Fw/Buffer/Buffer.fpp,$FPRIME_DIR/Fw/Dp/Dp.fpp,$FPRIME_DIR/Fw/Log/Log.fpp,$FPRIME_DIR/Fw/Prm/Prm.fpp,$FPRIME_DIR/Fw/Cmd/Cmd.fpp,$FPRIME_DIR/Fw/Time/Time.fpp,$FPRIME_DIR/Fw/Tlm/Tlm.fpp"
