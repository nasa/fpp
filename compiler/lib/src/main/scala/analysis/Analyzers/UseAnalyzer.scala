    ...
    data match {
      ...
      case special : Ast.SpecPortInstance.Special =>
        ...
        val name = special.kind match {
          ...
          case Ast.SpecPortInstance.ProductRecv => "DpBufferSend"
          case Ast.SpecPortInstance.ProductRequest => "DpBufferRequest"
          case Ast.SpecPortInstance.ProductSend => "DpBufferSend"
