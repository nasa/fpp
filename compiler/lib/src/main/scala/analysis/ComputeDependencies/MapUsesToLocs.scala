...
object MapUsesToLocs extends UseAnalyzer {
  ...
  override def componentInstanceUse(a: Analysis, node: Ast.QualIdent, use: Name.Qualified) =
    analyzeUse(a, Ast.SpecLoc.ComponentInstance, use)

  override def componentUse(a: Analysis, qualIdent: Ast.QualIdent, use: Name.Qualified) =
  ...
  override def portUse(a: Analysis, qualIdent: Ast.QualIdent, use: Name.Qualified) =
    analyzeUse(a, Ast.SpecLoc.Port, use)

  override def topologyUse(a: Analysis, qualIdent: Ast.QualIdent, use: Name.Qualified) =
