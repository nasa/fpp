...
case class StateMachineAnalysis(
  ...
  StateMachineSymbol.State = {
    ...
    val stateSym @ StateMachineSymbol.State(_) = sym.runtimeChecked
    stateSym
  }
  ...
  StateMachineSymbol.Action = {
    ...
    val actionSym @ StateMachineSymbol.Action(_) = sym.runtimeChecked
    actionSym
  }
  ...
  StateMachineSymbol.Guard = {
    ...
    val guardSym @ StateMachineSymbol.Guard(_) = sym.runtimeChecked
    guardSym
  }
  ...
  StateMachineSymbol.Signal = {
    ...
    val signalSym @ StateMachineSymbol.Signal(_) = sym.runtimeChecked
    signalSym
  }
