== Models and Translation Units

=== Models

A *model* is a collection of one or more
<<Models-and-Translation-Units_Translation-Units,translation
...
<<Models-and-Translation-Units_Translation-Units_Example,Translation
units 1-3 in the following section>>, taken together, form a single
...
A *translation unit* forms part of a <<Models-and-Translation-Units_Models,model>>
at the top level.
