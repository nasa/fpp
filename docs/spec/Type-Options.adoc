...
<<Type-Options_Computing-a-Common-Type-Option,common type option>> stem:[O'_i] 
of stem:[O'_(i-1)] and stem:[O_i].

.  Use stem:[O'_n] as the common type option of the list.
