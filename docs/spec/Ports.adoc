...
* A <<Definitions_Module-Template-Definitions,template interface parameter>>.
...
For every template parameter definition _D_, this is an associated port interface _I_.
This port interface is named in the definition.
...
<<Definitions_Module-Template-Definitions,template interface parameter>>.
...
An template interface parameter's port interface will be named in the template
