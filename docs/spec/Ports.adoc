...
A *port interface instance* is a
<<Definitions_Component-Instance-Definitions,component instance definition>>,
<<Definitions_Topology-Definitions,topology definition>> or a
<<Template-Parameter-Lists,port interface instance template parameter>>.
...
An port interface instance template parameter's port interface will be named in the template
