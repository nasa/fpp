...
|Addition expressions stem:[e_1] `+` stem:[e_2] (<<Expressions_Arithmetic-Expressions, arithmetic addition>> or <<Expressions_String-Concatenation-Expressions, string concatenation>>) and subtraction expressions stem:[e_1] `-` stem:[e_2]
|Left
