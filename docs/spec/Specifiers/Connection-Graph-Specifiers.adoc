...
<<Specifiers_Port-Instance-Specifiers_Input-and-Output-Port-Instance-Specifiers,output 
port instance>> of one
component instance or topology to an
<<Specifiers_Port-Instance-Specifiers_Input-and-Output-Port-Instance-Specifiers,input 
port instance>> of
another one.
