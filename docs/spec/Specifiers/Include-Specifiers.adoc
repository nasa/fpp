...
During <<Analysis-and-Translation_Analysis,parsing>>, the translator does the
following:
...
All include specifiers are resolved this way, even ones that occur inside or
transitively inside a <<Definitions_Module-Template-Definitions,template
definition>>.
