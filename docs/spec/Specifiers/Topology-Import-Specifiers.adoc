...
An instance is public in _I''_ if it is public in _I_
or _I'_ or both; otherwise it is private.
...
When computing this disjoint union, it is an error if two or more
connections have the same specified port number at the same end point.
