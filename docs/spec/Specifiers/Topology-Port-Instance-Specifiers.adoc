...
allows topologies to <<Ports_Binding-of-Port-Interfaces,bind to port interfaces>>.
...
.. Providing a set of topology ports encapsulates port instance names and component
