...
If there are command parameters, all parameters in the parameter list must be 
a <<Types_Displayable-Types,displayable type>>, otherwise, the list may be omitted.
