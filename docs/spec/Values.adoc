...
A string value may be denoted by a
<<Expressions_String-Literals, string literal expression>>
or produced by a
<<Expressions_String-Concatenation-Expressions, string concatenation expression>>.
