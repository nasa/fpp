...
is part of a <<Interfaces,interface>> instance. Port instance
...
an <<Interfaces_Instance-Values,interface value _I_>>.

. _I_ must refer to an <<Interfaces,interface _I'_>>
