...
* _relative-qualident_

* _absolute-qualident_


_relative-qualident_ is one of the following:

* _<<Lexical-Elements_Identifiers,identifier>>_

* _relative-qualident_ `.` _<<Lexical-Elements_Identifiers,identifier>>_

_absolute-qualident_ is the following:

* `.` _relative-qualident_

The form _relative-qualident_ is called a *relative qualified identifier*.
It specifies a qualified name relative to an enclosing scope.

The form _absolute-qualident_ is called an *absolute qualified identifier*.
...
.. If _Q_ refers to a <<Definitions,definition>> _D_
