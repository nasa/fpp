...
_TODO: It seems that a template parameter should reside in the name
groups of the definition that it represents._
...
_TODO: Add the rules for resolution within an expanded template._
...
<<Analysis-and-Expansion-of-Templates_Resolution-of-Identifiers,
