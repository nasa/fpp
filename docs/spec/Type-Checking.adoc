...
. An anonymous array type stem:[T] may be converted to the array type stem:[T']
if stem:[T'] has size stem:[n] and element type stem:[T''], and
stem:[T] may be converted to the anonymous array type _[_ stem:[n] _]_ 
stem:[T''].
...
. An anonymous struct type stem:[T] may be 
converted to
the struct type stem:[T'] if stem:[T'] has members 
_{_ stem:[m'_i] _:_ stem:[T'_i] _}_, and stem:[T] 
may be converted to the anonymous struct type
_{_ stem:[m'_i] _:_ stem:[T'_i] _}_.
