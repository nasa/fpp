...
with element type stem:[T].
If stem:[T_1] is a fixed-size array type, then let stem:[n] be its size.
If stem:[T_1] is a variable-size array type, then let stem:[n] be its maximum
size.
...
. An anonymous fixed-size array type stem:[T_1 =] _[_ stem:[n] _]_ stem:[T'_1]
may be converted to the anonymous fixed-size array type
stem:[T_2 =] _[_ stem:[m] _]_ stem:[T'_2]
if stem:[n = m] and stem:[T'_1] may be converted to stem:[T'_2].

. An anonymous fixed-size array type stem:[T_1 =] _[_ stem:[n] _]_ stem:[T'_1]
may be converted to the anonymous variable-size array type
stem:[T_2 =] _[_ `size` stem:[m] _]_ stem:[T'_2]
if stem:[n <= m] and stem:[T'_1] may be converted to stem:[T'_2].
Note that the size-prefix type of a variable-size array type does not affect
convertibility.

. An anonymous variable-size array type stem:[T_1 =] _[_ `size` stem:[n] _]_ stem:[T'_1]
may be converted to the anonymous variable-size array type
stem:[T_2 =] _[_ `size` stem:[m] _]_ stem:[T'_2]
if stem:[n <= m] and stem:[T'_1] may be converted to stem:[T'_2].
...
fixed-size array type stem:[T_2] if stem:[T_1] may be converted to the member
type of stem:[T_2].
...
. Otherwise if stem:[T_1] and stem:[T_2] are anonymous fixed-size array types with the same size stem:[n]
