...
All parameters defined in a component must have distinct identfier values.
...
All telemetry channels defined in a component must have distinct identfier values.
...
All events defined in a component must have distinct identfier values.
