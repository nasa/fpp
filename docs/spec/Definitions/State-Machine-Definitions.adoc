...
.. No two
<<State-Machine-Behavior-Elements_State-Transition-Specifiers,state transition specifiers>>
may
<<Definitions_State-Machine-Definitions_Scoping-of-Names,refer>>
to the same signal definition.

.. _M_ must statisfy the rules described
