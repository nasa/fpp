...
*The fully qualified name of a connection endpoint:*
Each connection endpoint _I_ `.` _p_ or _I_ `.` _p_ `[` _n_ `]`
...
*Ordering of connection endpoints:*
...
. Otherwise if stem:[e_1] and stem:[e_2] have assigned port numbers
port numbers stem:[n_1] and stem:[n_2] in the model source,
