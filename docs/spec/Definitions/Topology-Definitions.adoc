...
verify that this <<Interfaces_Anonymous-Interfaces_Anonymous-Topology-Interfaces,
topology's anonymous interface>> can <<Interfaces_Binding,bind>> to _ID_.
...
instances present in _T_ or are <<Specifiers_Topology-Port-Specifiers,topology ports>>
