...
instances present on interface instances available in _T_. An interface
instance _I_ is available in _T_ if:

.. _I_ is a topology definition in _S_.

.. _I_ is named through a <<Specifiers_Interface-Instance-Specifiers,
instance specifier>> in _T_.
