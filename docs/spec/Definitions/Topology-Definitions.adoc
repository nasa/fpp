...
* _I_ refers to a
<<Definitions_Component-Instance-Definitions,component instance>> or
an <<Specifiers_Topology-Import_Specifiers,imported>> <<Definitions_Topology-Definitions,topology definition>>.
...
_I_. _I_ must be <<Specifiers_Topology-Import_Specifiers,imported>> into the parent topology of the connection.
