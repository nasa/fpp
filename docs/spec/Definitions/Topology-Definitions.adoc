...
In the FPP source, connections can go from or to either component
instances or topologies.
Before generating code, connections to topologies are flattened,
so that all connections go from and to the ports of component instances.
