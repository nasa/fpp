...
. Let _S_ be the set of all topologies or port interface instance template parameters that
refer to topologies that are named as
...
... Check that the component instance's included port interface _P~I~_ has the port instance _I_
...
... Check that the topology's included port interface _P~I~_ has the port instance _I_
