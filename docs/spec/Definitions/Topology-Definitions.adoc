...
* A <<Specifiers_Topology-Port-Instance-Specifiers,topology port specifier>>
...
and the set of
<<Specifiers_Topology-Port-Instance-Specifiers,ports>> in the topology
...
<<Specifiers_Topology-Port-Instance-Specifiers,topology port>> inside _I_.
