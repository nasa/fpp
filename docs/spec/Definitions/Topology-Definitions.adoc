...
At each output port _p_ of each <<Port-Interfaces_Port-Interface-Instance,
port interface instance _I_>>, check the following:
...
For each port interface instance _I_ in the topology:

. Let _C_ be the <<Port-Interfaces,port interface>> of _I_.
...
topology CDH {
  ...
  # ----------------------------------------------------------------------
  # Local component instance definitions
  # ----------------------------------------------------------------------
