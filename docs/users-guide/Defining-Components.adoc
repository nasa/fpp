...
for (1) providing buffers that can store data products in memory;
...
https://github.com/nasa/fprime/blob/devel/docs/Design/data-products.md[documentation]
...
the container (e.g., the size of the data payload), and a list
of *records*.
A record is a unit of data.
For a complete specification of the container format, see the 
https://github.com/nasa/fprime/blob/devel/Fw/Dp/docs/sdd.md[F
Prime data products documentation].
