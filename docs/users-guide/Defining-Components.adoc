...
*GDS limitation:* The F Prime GDS does not currently support the
use of <<Defining-Types_Array-Type-Definitions, array types>> or
<<Defining-Types_Struct-Type-Definitions, struct types>> in the formal parameters
of commands.
...
*GDS limitation:* The F Prime GDS does not currently support the
use of <<Defining-Types_Array-Type-Definitions, array types>> or
<<Defining-Types_Struct-Type-Definitions, struct types>> as the
types of parameters.
In particular, parameter `Param3` in the example above will
not work with the F Prime GDS.
