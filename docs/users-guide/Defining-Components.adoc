...
For checking simple examples, you can provide 
...
If you don't do this, or something similar, then the code won't 
pass through `fpp-check` because of the missing ports.
(Try it and see.)
