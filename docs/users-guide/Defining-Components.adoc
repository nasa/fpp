...
code for _C_.
Sometimes it is convenient to store and manage parameters separately,
for example when integrating an F Prime component with a library
...
passive component ParamExternal {
  ...
  @ Parameter 1 is an internal parameter
  param Param1: U32

  @ Parameter 2 is an external parameter
