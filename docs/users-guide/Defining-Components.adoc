...
in the section on constructing topologies of component instances.
...
* `activity` `high`: Spacecraft activity of high importance.

* `activity` `low`: Spacecraft activity of low importance.
...
* `warning` `high`: A warning of high importance.

* `warning` `low`: A warning of low importance.
