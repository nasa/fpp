...
These types are required by the F Prime GDS, so they are included in the dictionary.
...
See the
https://fprime.jpl.nasa.gov/latest/docs/user-manual/framework/configuring-fprime/[F 
