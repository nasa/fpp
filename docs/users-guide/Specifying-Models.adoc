...
each definition is the location of the file where the definition occurs,
not where the file is included.
For example, suppose that file `a.fpp` contains the definition `constant a = 0`,
