...
To specify the data, you write more *formal parameters*
enclosed in parentheses.
These are similar to the formal parameters of a function in a programming
...
_P_ is *invoked*.
The invocation generally occurs in {cpp} code that you write by hand.
...
a return value.
Such a port may be used only in a synchronous context.
...
Finally, there can be ave any number of reference parameters,
