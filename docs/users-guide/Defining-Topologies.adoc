...
This is the the top-level topology of an F Prime deployment.
...
==== Using an Imported Topology in a Deployment
...
. Define `System` as a deployment topology.

. Define `Subsystem` as a non-deployment topology and import `System`
into `System`, as described in the previous sections.

. Define a deployment topology `SubsystemDeployment` that imports
`Subsystem`.
...
deployment topology System { import Subsystem }

deployment topology SubsystemDeployment { import Subsystem }
----
