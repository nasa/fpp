...
one topology into another one and to encapulate topologies
into blackboxes using topology *ports*.
...
Notice that the the topology `A` is not distinguished from a compnent instance
...
Earlier in this section we elluded that topology definitions can
...
topology B {
  ...
  instance A # import the topoology
