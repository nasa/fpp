...
In the F Prime framework, this type is represented as the {cpp} type `Fw::String`.
The maximum size of this string is specified by the
...
[source,fpp]
----
# A is an array of 3 strings with maximum size FW_FIXED_LENGTH_STRING_SIZE
array A = [3] string
----
