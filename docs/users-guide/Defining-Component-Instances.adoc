...
*Automatic location:*
The translator can automatically locate the header file if it
...
This definition specifies that the implementation header file
is `Svc/LinuxTime/LinuxTimeImpl.hpp`.
