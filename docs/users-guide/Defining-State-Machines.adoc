...
The simplest internal state machine _M_ that has any useful
...
In general, a state transition specifier causes a transitions only
from the state in which it appears.
