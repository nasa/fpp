...
In this section we divide all transitions between
directly related states into several categories, which we describe.
In each category, the behavior that we describe follows from the general behavior
