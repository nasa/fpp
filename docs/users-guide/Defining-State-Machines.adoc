...
discuss 
<<Defining-State-Machines_Hierarchy_Entry-and-Exit-Actions-with-Hierarchy,below>>
...
==== Entry and Exit Actions with Hierarchy
...
We may call this kind of transition an *ancestor state transition*.
Note the following:
