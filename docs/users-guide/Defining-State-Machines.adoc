...
As with <<Defining-State-Machines_Internal-State-Machines,signals>>,
...
<<Defining-State-Machines_Internal-State-Machines,state transitions>>
...
<<Defining-State-Machines_State-Transitions_Self-Transitions,self transition>>,
...
* The name of a 
* <<Defining-State-Machines_State-Transitions_Guarded-Transitions,guard>>
_G_.
...
<<Defining-State-Machines_Internal-State-Machines, a state machine 
without hierarchy>>.
...
<<Defining-State-Machines_State-Transitions_Internal-Transitions,internal 
transition>>
