...
You can use a port interface to specify the
interface of a topology.
We will explain how to do this in the section on
<<Defining-Topologies_Topology-Ports_Implementing-Port-Interfaces,
defining topologies>>.
