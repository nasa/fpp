...
Sections <<Defining-Constants,3>> through <<Defining-Systems,16>>
...
<<Specifying-Models-as-Files,Section 17>> explains how to specify
a model as a collection
of files: for example, it covers the management of dependencies
between files.
<<Analyzing-and-Translating-Models,Section 18>> explains how to
